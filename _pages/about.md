...
During his first data structures class during his sophomore year, Mridul questioned the professor, "Why do we only assign bits a value of 0 or 1, rather why not utilize all numbers between 0 and 1. This would allow for an infinite number of data points to be stored, theoretically." During this time Mridul, a sophomore, had no clue what quantum computing was and how it works and more notably had no understanding of Electrical Engineering.     
