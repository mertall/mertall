...
geometry: margin=4cm
---
<iframe width="560" height="315" src="//18.157.181.25:/WebRTCAppEE/play.html?name=059584042866659895646317" frameborder="0" allowfullscreen></iframe>    
> TL;DR
...
```
From here we apply the inverse of the Hadmard, this is just the conjugate transpose since Hadamard is unitary. This can be implemented by simply applying Hadamard.
```
